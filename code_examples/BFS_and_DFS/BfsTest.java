...
public class BfsTest {
    ...
    /**
     * Test case for a BFS traversal on a standard, non-empty tree.
     * Verifies that the traversal order matches the expected level-by-level order.
     */
    @Test
    void testStandardTreeTraversal() {
        Node root = buildSampleTree();
        List<String> expected = Arrays.asList("A", "B", "C", "D", "E", "F", "G", "H");
        List<String> actual = BFS.traverse(root);
        assertEquals(expected, actual, "Traversal order should match expected BFS level-by-level order.");
    }

    /**
     * Test case for a BFS traversal on a tree with only a single node.
    ...
    /**
     * Test case for a BFS traversal on an empty tree (null root).
    ...
    /**
     * Test case for a BFS traversal on a left-skewed tree.
     * The traversal should return the nodes in a level-by-level order.
     * Tree: A -> B -> C
     */
    @Test
    ...
    /**
     * Test case for a BFS traversal on a right-skewed tree.
     * The traversal should return the nodes in a level-by-level order.
     * Tree: A -> B -> C
     */
    @Test
